import { Users, Play, ChevronRight, Clock, CheckCircle, XCircle } from "lucide-react";
...
function HostLobby() {
  ...
  // Countdown timer — auto-ends question when timer hits 0
  useEffect(() => {
      ...
      <div className="min-h-screen bg-gray-950 text-white flex flex-col items-center p-8">
        <div className="w-full max-w-3xl">
            ...
            <div className="grid grid-cols-2 gap-3">
              {currentQuestion.answers.map((answer, i) => {
                ...
                return (
                  <div
                    key={answer.id}
                    className={`${ANSWER_COLORS[i % 4]} ${isCorrect ? "ring-4 ring-white" : "opacity-40"}
                      rounded-xl px-4 py-4 font-semibold flex items-center gap-2 transition-all`}
                  >
          ...
          <button
            ...
            className="w-full py-4 rounded-xl font-bold bg-violet-500 hover:bg-violet-400 transition flex items-center justify-center gap-2"
          >
      ...
      <div className="min-h-screen bg-gray-950 text-white flex flex-col items-center p-8">
        <div className="w-full max-w-3xl">
            ...
            <div className="flex-1">
              ...
              <div className="w-full h-2 bg-white/10 rounded-full">
                <div
                  ...
                  style={{ width: answerCount.total > 0 ? `${(answerCount.answered / answerCount.total) * 100}%` : "0%" }}
                />
              </div>
            </div>
          </div>
          ...
          <button
            ...
            disabled={questionEndedRef.current}
            className="w-full py-4 rounded-xl font-bold bg-orange-500 hover:bg-orange-400 disabled:opacity-40 disabled:cursor-not-allowed transition flex items-center justify-center gap-2"
          >
